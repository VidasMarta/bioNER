...
if __name__ == "__main__":    
    ...
    model_name, model_args, settings_args = extract_args()
    model_name = "S_ftB_C_L_5_A_with_kshot_50pct" #"ES_S_with_0shot"
    settings_args['dataset'] = 'kshot/50_pct/' #'distemist/trf/synthetic/kshot_20pct/'
    settings_args['train_filename'] = 'corrected_generated_sentences_20260304.jsonl' #'corrected_generated_sentences_20260318.jsonl'
    print_args(model_args, settings_args)
    output_path = os.path.join(settings.LOG_PATH, model_name)
    logger = Logger(output_path, model_args, settings_args)

    new_model_name = "kshot_50pct_C_L_5_A_with_50NCBI_ft"  #"kshot_20pct_ft_with_10DISTEMIST" #D1_ftB_C_L_5_A_mean_with_genData
    ...
    for seed in [42, 198, 6000, 3828, 7382]:
        ...
        settings_args_2['dataset'] = 'ncbi_disease_json/trf/' #'distemist/trf/'
        settings_args_2['train_filename'] = 'train_50pct.json' # 'train.json', train_50pct.json
    ...
    logger_2.calculate_mean_stddev(training_set="3-shot\_50pct", file_to_save=os.path.join(settings.LOG_PATH, "ncbi/50_pct/test.csv"))
