...
if __name__ == "__main__":    
    ...
    settings_args['train_filename'] = 'train_10pct.jsonl' #train_10pct.json
    ...
    logger.calculate_mean_stddev(training_set="-", file_to_save=os.path.join(settings.LOG_PATH, "bronco150/10pct/test.csv"))
    """
