...
if __name__ == "__main__":    
    ...
    new_model_name = "NCBI_filtered1_ft_with_20NCBI" #D1_ftB_C_L_5_A_mean_with_genData
    ...
    logger.calculate_mean_stddev(training_set="-", file_to_save=os.path.join(settings.LOG_PATH, "ncbi/filtered1/test.csv"))
    logger_2.calculate_mean_stddev(training_set="filtered1", file_to_save=os.path.join(settings.LOG_PATH, "ncbi/20_pct/test.csv"))
