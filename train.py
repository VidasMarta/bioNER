...
if __name__ == "__main__":    
    ...
    settings_args['train_filename'] = 'corrected_generated_sentences_202603.jsonl' #train_10pct.json
    ...
    logger.calculate_mean_stddev(training_set="-", file_to_save=os.path.join(settings.LOG_PATH, "distemist/kshot_20_pct/test.csv"))'''
    """
    ...
    new_model_name = "0shot_ft_with_20DISTEMIST" #D1_ftB_C_L_5_A_mean_with_genData
    ...
    logger_2.calculate_mean_stddev(training_set="0-shot", file_to_save=os.path.join(settings.LOG_PATH, "distemist/20_pct/test.csv"))
