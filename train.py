...
if __name__ == "__main__":    
    ...
    new_model_name = "kshot_50pct_C_L_5_A_with_NCBI_ft"  #"kshot_20pct_ft_with_10DISTEMIST" #D1_ftB_C_L_5_A_mean_with_genData
    ...
    logger_2.calculate_mean_stddev(training_set="3-shot\_50pct", file_to_save=os.path.join(settings.LOG_PATH, "ncbi/100_pct/test.csv"))
