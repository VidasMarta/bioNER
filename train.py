...
if __name__ == "__main__":    
    ...
    settings_args['train_filename'] = 'corrected_generated_sentences_20260317.jsonl' #train_10pct.json
    ...
    logger.calculate_mean_stddev(training_set="-", file_to_save=os.path.join(settings.LOG_PATH, "distemist/kshot/10pct/test.csv"))
    """
